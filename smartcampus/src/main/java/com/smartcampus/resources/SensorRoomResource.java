...
public class SensorRoomResource {
    ...
    public Response deleteRoom(@PathParam("roomId") String roomId) {
        Room room = rooms.get(roomId);
        System.out.println("DEBUG: Checking room " + roomId + ". Sensor list size is: " + room.getSensorIds().size());
        ...
        if (!room.getSensorIds().isEmpty()) {
            throw new com.smartcampus.exceptions.RoomNotEmptyException("Cannot delete: Room contains active sensors.");
        }
